...
- Show current session details (type emoji, name, `#tag`) in the menu bar command
- Log and confirm focus sessions even when ended early from controls
- Add quick action to copy the full session history as JSON from the log view

## [Docs] - 2025-10-27

- Refresh README with up-to-date overview, commands, and local dev instructions
- Add ROADMAP.md to track upcoming features, quality-of-life work, and bug fixes
